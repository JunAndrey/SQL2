...
SELECT Album_name, date_release FROM AlbumList
WHERE date_release BETWEEN '20180101' AND '20181231';

SELECT track_name, duration_track_sec / 60 FROM Track
WHERE duration_track_sec = (SELECT MAX(duration_track_sec) FROM Track);

SELECT track_name, duration_track_sec / 60 FROM Track
WHERE duration_track_sec >= 210 / 60;

SELECT Album_name, date_release FROM AlbumList
WHERE date_release BETWEEN '20180101' AND '20201231';
 
SELECT artist_name FROM ListArtists
